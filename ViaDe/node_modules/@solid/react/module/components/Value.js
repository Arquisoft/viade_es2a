...
export default function Value({
  ...
  else if (pending) return children || React.createElement("span", {
      className: "solid value pending"
    }); // Render error state
    else if (error) return children || React.createElement("span", {
        className: "solid value error",
        "data-error": error.message
      }); // Render empty value
      else return children || React.createElement("span", {
