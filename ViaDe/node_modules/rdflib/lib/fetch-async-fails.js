...
function () {
  ...
  */
  ...
  (0, _createClass2.default)(Fetcher, [{
    ...
    key: "fetchUri",
    value: function () {
      var _fetchUri = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee(docuri, options) {
        var state, message, dummyResponse, _response, actualProxyURI, response, _dummyResponse, resp;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                throw new Error('Cannot fetch an empty uri');
              ...
              case 2:
                ...
                return _context.abrupt("return", this.failFetch(options, 'fetcher: Unsupported protocol', 'unsupported_protocol'));

              case 4:
                state = this.getState(docuri);
                ...
                return _context.abrupt("return", this.doneFetch(options, {
                  status: 200,
                  ok: true,
              ...
              case 8:
                ...
                message = 'Previously failed: ' + this.requested[docuri];
                dummyResponse = {
                  url: docuri,
              ...
              case 18:
                ...
                actualProxyURI = options.actualProxyURI;
                _context.prev = 22;
                response = this._fetch(actualProxyURI, options);
                _context.next = 31;
                break;
              ...
              case 26:
                ...
                _dummyResponse = {
                  ...
                  statusText: (_context.t0.name || 'network failure') + ': ' + (_context.t0.errno || _context.t0.code || _context.t0.type),
                  responseText: _context.t0.message,
                  headers: {},
                  // Headers() ???
                  ok: false,
                  body: null,
                ...
                console.log('Fetcher: <' + actualProxyURI + '> Non-HTTP fetch exception: ' + _context.t0);
                return _context.abrupt("return", this.handleError(_dummyResponse, docuri, options));

              case 31:
                _context.next = 33;
                return this.handleResponse(response, docuri, options);
      ...
      function fetchUri(_x, _x2) {
        return _fetchUri.apply(this, arguments);
      }
    ...
    value: function webCopy(here, there, contentType) {
      ...
      return this.webOperation('GET', here).then(function (result) {
        return _this5.webOperation('PUT', // change to binary from text
        there, {
    ...
    value: function _delete(uri, options) {
      ...
      return this.webOperation('DELETE', uri, options).then(function (response) {
        _this6.requested[uri] = 404;
        _this6.nonexistent[uri] = true;

        _this6.unload(_this6.store.sym(uri));
    ...
    */
    ...
    value: function () {
        ...
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                contentType = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : 'text/turtle';
      ...
      function createIfNotExists(_x3) {
    ...
    */
    ...
    value: function retryNoCredentials(docuri, options) {
      ...
      try {
        var promise = this.load(docuri, newOptions);
      } catch (err) {
        console.log("RETRY of ".concat(docuri, " WITHOUT CREDENTIALS FAILED too: <<<").concat(err, ">>>\n")); // return Promise.reject(@@)

        var response = err.response || {
          status: 996
        };
        return this.failFetch(options, 'Failed ALSO without ccredentials: ' + err, 996, response);
      }

      console.log('RETRY WITHOUT CREDENTIALS WORKED SO FAR! ' + docuri);
      return promise; // return this.handleResponse(response, docuri, options)
    ...
    value: function handleResponse(response, docuri, options) {
      ...
      if (response.status >= 400) {
        ...
        return this.saveErrorResponse(response, responseNode).then(function () {
          ...
          return _this8.failFetch(options, errorMessage, response.status, response);
        });
      }
      ...
      return response.text().then(function (responseText) {
        ...
        return handler.parse(_this8, responseText, options, response);
      });
    } // handleResponse
    ...
    value: function redirectToProxy(newURI, options) {
      ...
      return this.fetchUri(newURI, newOptions).then(function (response) {
        if (!newOptions.noMeta) {
          kb.add(oldReq, ns.link('redirectedRequest'), newOptions.req, _this9.appNode);
        }
    ...
    value: function setRequestTimeout(uri, options) {
      ...
      return new Promise(function (resolve) {
        _this10.timeouts[uri] = (_this10.timeouts[uri] || []).concat(setTimeout(function () {
          if (_this10.isPending(uri) && !options.retriedWithNoCredentials && !options.proxyUsed) {
            resolve(_this10.failFetch(options, "Request to ".concat(uri, " timed out"), 'timeout'));
          }
        }, _this10.timeout));
      });
    }
